...
public class LinkedListMaxHeap<T extends Comparable<T>> implements Heap<T> {
	...
	public LinkedListMaxHeap(List<T> linkedList) {
	...
	public T getRoot() {
		if (isEmpty())
			throw new NoSuchElementException("LinkedListMaxHeap is Empty...");
	...
	public String toString() {
		StringBuilder stringBuilder = new StringBuilder("LinkedListMaxHeap [size=" + size());
